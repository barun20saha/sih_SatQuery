...
const MODELS = [
  ...
  {
    name: 'Qwen2-VL + LoRA',
    role: 'Visual Question Answering & Captioning',
    modality: 'RGB / Optical',
    architecture: 'Qwen2-VL-2B-Instruct + LoRA/QLoRA',
    parameters: 'N/A',
    latency: 'N/A',
    accuracy: 'N/A',
    status: 'online',
    description: 'Advanced visual question answering and captioning model fine-tuned with LoRA.',
  },
  {
    name: 'Optical Change Detection',
    role: 'Bi-temporal Change Detection',
    modality: 'Optical T1 + T2',
    architecture: 'Siamese ResNet-18 + GRU + MLP',
    parameters: 'N/A',
    latency: 'N/A',
    accuracy: 'N/A',
    status: 'online',
    description: 'Bi-temporal optical change detection for identifying structural differences over time.',
  },
  {
    name: 'Optical-SAR Fusion',
    role: 'Cross-modal Change Detection',
    modality: 'Optical + SAR',
    architecture: 'Dual-Branch Encoder + Feature Fusion',
    parameters: 'N/A',
    latency: 'N/A',
    accuracy: 'N/A',
    status: 'online',
    description: 'Cross-modal change detection fusing optical and SAR data for robust analysis.',
  },
  {
    name: 'Multispectral CNN',
    role: 'Multispectral Analysis',
    modality: 'Sentinel-2 / Multispectral',
    architecture: 'CNN-based feature extractor',
    parameters: 'N/A',
    latency: 'N/A',
    accuracy: 'N/A',
    status: 'online',
    description: 'CNN-based feature extractor for in-depth multispectral image analysis.',
  },
  {
    name: 'Grounding / SAM',
    role: 'Region Localization',
    modality: 'Optical / RGB',
    architecture: 'SAM-style segmentation/grounding model',
    parameters: 'N/A',
    latency: 'N/A',
    accuracy: 'N/A',
    status: 'online',
    description: 'Region localization and instance segmentation using SAM-style grounding.',
  },
  {
    name: 'Bi-temporal CD-VQA',
    role: 'Change Understanding + QA',
    modality: 'T1 + T2 + Question',
    architecture: 'Siamese visual encoder + temporal modeling + VQA head',
    parameters: 'N/A',
    latency: 'N/A',
    accuracy: 'N/A',
    status: 'online',
    description: 'Integrated bi-temporal change understanding combined with question answering capabilities.',
  }
];
